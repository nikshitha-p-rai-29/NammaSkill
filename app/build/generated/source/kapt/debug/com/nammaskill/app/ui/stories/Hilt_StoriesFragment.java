 ...
 */
public abstract class Hilt_StoriesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_StoriesFragment() {
    super();
  }

  Hilt_StoriesFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((StoriesFragment_GeneratedInjector) this.generatedComponent()).injectStoriesFragment(UnsafeCasts.<StoriesFragment>unsafeCast(this));
    }
  }
