 ...
 */
public abstract class Hilt_CourseDetailFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CourseDetailFragment() {
    super();
  }

  Hilt_CourseDetailFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CourseDetailFragment_GeneratedInjector) this.generatedComponent()).injectCourseDetailFragment(UnsafeCasts.<CourseDetailFragment>unsafeCast(this));
    }
  }
