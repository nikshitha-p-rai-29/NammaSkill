 ...
 */
public abstract class Hilt_AddCourseFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddCourseFragment() {
    super();
  }

  Hilt_AddCourseFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddCourseFragment_GeneratedInjector) this.generatedComponent()).injectAddCourseFragment(UnsafeCasts.<AddCourseFragment>unsafeCast(this));
    }
  }
