 ...
 */
public abstract class Hilt_ApplyFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ApplyFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ApplyFragment_GeneratedInjector) this.generatedComponent()).injectApplyFragment(UnsafeCasts.<ApplyFragment>unsafeCast(this));
    }
  }
