 ...
 */
public abstract class Hilt_PingFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PingFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PingFragment_GeneratedInjector) this.generatedComponent()).injectPingFragment(UnsafeCasts.<PingFragment>unsafeCast(this));
    }
  }
