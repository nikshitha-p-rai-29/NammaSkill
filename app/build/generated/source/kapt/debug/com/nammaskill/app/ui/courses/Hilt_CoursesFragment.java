 ...
 */
public abstract class Hilt_CoursesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CoursesFragment() {
    super();
  }

  Hilt_CoursesFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CoursesFragment_GeneratedInjector) this.generatedComponent()).injectCoursesFragment(UnsafeCasts.<CoursesFragment>unsafeCast(this));
    }
  }
